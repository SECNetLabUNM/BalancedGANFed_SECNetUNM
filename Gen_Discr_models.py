...
class ResidualBlock(nn.Module):
    ...
    def __init__(self, dim_in, dim_out):
        ...
        self.main = nn.Sequential(
            ...
            nn.InstanceNorm2d(dim_out, affine=True, track_running_stats=True), #instance normalization with to 4D-input
...
class Discriminator(nn.Module):
    ...
    def __init__(self, conv_dim, m_dim, b_dim, dropout, num_types_delta = 0): # num_types_d: atom_num_types[dataset] - atom_num_types['qm8_smiles'] 
        ...
        self.agg_layer = GraphAggregation(graph_conv_dim[-1]+ num_types_delta, aux_dim, b_dim, dropout)
